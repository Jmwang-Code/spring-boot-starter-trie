...
public class TirePrefixQuerierTest {
    ...
    public void one(){
        TirePrefixQuerier 南天 = new TirePrefixQuerier(trieNode, new TokenizerObject("南天"));
        TriePrefixQueryResult triePrefixQueryResult = 南天.queryAllPrefix();
